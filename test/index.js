...
//   it('renders strings without newlines as a single paragraph', function() {
//     assert(this.inputElement === '<div><p>You cannot connect the dots looking forward; You can only connect them looking backward</p></div>')
//   })
// })
